...
import { Button, Image, ImageContainer } from "../CommonStyles"
...
const ContactForm: React.FC<IContactProps> = ({ contactData, edit, onSubmit, onDelete }) => {
    const [displayFormStatus, setDisplayFormStatus] = React.useState(false)
    const [formData, setFormData] = React.useState<IContactForm>({ name: '', surname: '', phone: '', email: '' })
                    ...
                    {(props: FormikProps<IContactForm>) => {
                        ...
                        return (
                            <Form>
                                ...
                                {formData.photoUrl ? <ImageContainer>
